                ...
                <div className="lg:max-w-[570px] w-full">
                  <div className="lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2 p-4 sm:p-7.5 relative flex items-center justify-center">
                    <div>
                      ...
                      <Image
                        src={product.imgs?.previews?.[previewImg] || "/images/products/product-1-sm-1.png"}
                        alt={product.title || "product image"}
                        width={400}
                        height={400}
                        placeholder={(product as any).blurDataURL ? "blur" : "empty"}
                    ...
                    {product.imgs?.thumbnails.map((item, key) => (
                      ...
                      >
                        <Image
                          width={50}
                          height={50}
                          src={item || "/images/products/product-1-sm-1.png"}
                          alt="thumbnail"
                          placeholder={(product as any).blurDataURL ? "blur" : "empty"}
                          blurDataURL={(product as any).blurDataURL}
                          sizes="50px"
