    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
          ...
          {/* <!-- header top right --> */}
          <div className="flex w-full lg:w-auto items-center justify-end gap-5 lg:gap-7.5 flex-shrink-0">
              ...
              <div className="flex items-center gap-3 lg:gap-5 flex-shrink-0">
                ...
                {session && session.user ? (
                  <div className="flex items-center gap-2">
                    {/* Icon user + tên user */}
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="rounded-full bg-gray-2 flex-shrink-0">
                    ...
                    <div className="hidden sm:block">
                      ...
                      <p className="font-medium text-custom-sm text-dark truncate max-w-[120px]">{session.user.name || session.user.email}</p>
                    </div>
                    {/* VIP Badge */}
                    <VIPBadge />
                    ...
                    <button
                      onClick={() => signOut()}
                      className="hidden sm:inline-flex px-3 py-1 rounded bg-gray-2 text-dark hover:bg-blue hover:text-white text-xs flex-shrink-0"
                    >
                      Đăng xuất
                    </button>
                  </div>
                ) : (
                  <Link href="/signin" className="flex items-center gap-2.5 flex-shrink-0">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            <button
              id="Toggle"
              aria-label="Toggler"
              className="xl:hidden block flex-shrink-0"
